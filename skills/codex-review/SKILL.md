...
name: codex-review
description:
  "Ask Codex to review KeyPears work. Use when the user requests Codex review or
  during large/risky experiments before acting on conclusions."
---

# Codex Review

Use Codex as an independent external reviewer for KeyPears issue designs, code
diffs, experiment results, and architectural decisions. In the KeyPears review
mode taxonomy this skill implements `external-codex`.
