...
export default function NewVaultStep2() {
  ...
  // Redirect to step 1 if no vault name/domain
  useEffect(() => {
    if (!vaultName || !vaultDomain) {
      navigate(href("/new-vault/1"));
    }
  }, [vaultName, vaultDomain, navigate]);
          ...
          <div className="border-border bg-card rounded-lg border p-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground mt-1 text-sm">
                Step 2 of 3: Choose your password
              </p>
            </div>

            {/* Show vault name being created */}
            <div className="bg-muted/50 mb-6 rounded-lg p-3">
              <p className="text-muted-foreground text-xs">Creating vault</p>
