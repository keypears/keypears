...
const WEBAPP_DIR = path.dirname(fileURLToPath(import.meta.url));
const BLOG_DIR = path.resolve(WEBAPP_DIR, "src/blog");
const OUTPUT_DIR = path.resolve(WEBAPP_DIR, "public/blog");
