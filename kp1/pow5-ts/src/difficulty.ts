 ...
 */
export function targetFromDifficulty(difficulty: bigint): FixedBuf<32> {
  if (difficulty <= 0n) {
 ...
 */
export function difficultyFromTarget(target: FixedBuf<32>): bigint {
 ...
 */
export function hashMeetsTarget(
  hash: FixedBuf<32>,
  target: FixedBuf<32>,
): boolean {
