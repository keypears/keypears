...
// ============================================================================
export const GetVaultInfoRequestSchema = z.object({
  name: z.string(),
  domain: z.string(),
});
...
// ============================================================================
// Get vault info public (no auth required)
// ============================================================================
export const GetVaultInfoPublicRequestSchema = z.object({
  name: z.string(),
  domain: z.string(),
});

export const GetVaultInfoPublicResponseSchema = z.object({
  vaultId: z.string(),
  name: z.string(),
  domain: z.string(),
  encryptedVaultKey: z.string(),
...
export const CreateSecretUpdateRequestSchema = z.object({
  ...
  encryptedBlob: z
    .string()
    .min(1)
    .max(MAX_ENCRYPTED_DATA_BYTES * 2), // Encrypted JSON (hex, max 10KB)
});
...
// PoW Algorithm enum
// ============================================================================
// Currently only pow5-64b, more may be added in the future
...
// ============================================================================
// Looks up challenge from database and marks as used
...
// Vault Settings
// ============================================================================
// Stores user-configurable vault settings
...
// ============================================================================
// Creates or returns existing key for outgoing messages
...
// ============================================================================
// Public endpoint for key exchange
...
// Send message
// ============================================================================
// Public endpoint, PoW already consumed during getCounterpartyEngagementKey
...
// Get channels
// ============================================================================
// List channels for an address with pagination
...
// ============================================================================
// Look up engagement key ID from public key
...
// Get sender channel
// ============================================================================
// Get or create the sender's channel_view for a counterparty
...
// ============================================================================
// Returns messages from all channels for vault sync
...
// ============================================================================
// Remove messages after they've been synced to vault
...
// ============================================================================
// Set per-channel PoW difficulty override
...
// ============================================================================
// Public endpoint for cross-domain identity verification
