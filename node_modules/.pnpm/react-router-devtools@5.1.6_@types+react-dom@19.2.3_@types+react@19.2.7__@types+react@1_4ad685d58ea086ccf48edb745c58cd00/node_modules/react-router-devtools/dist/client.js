...
var Section = ({ initial, dispatch, children }) => {
  return /* @__PURE__ */ jsx6(Context.Provider, { value: initial, children: /* @__PURE__ */ jsx6(DispatchSection.Provider, { value: dispatch, children }) });
};
...
function TriangleArrow(props) {
  ...
  return /* @__PURE__ */ jsx7("svg", { viewBox: "0 0 24 24", fill: "var(--w-rjv-arrow-color, currentColor)", style: defaultStyle, ...reset, children: /* @__PURE__ */ jsx7("path", { d: "M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z" }) });
}
...
var initialState3 = {
  Arrow: {
    ...
    children: /* @__PURE__ */ jsx8(TriangleArrow, {})
  },
  Colon: {
    as: "span",
    style: {
...
var Symbols = ({ initial, dispatch, children }) => {
  return /* @__PURE__ */ jsx8(Context2.Provider, { value: initial, children: /* @__PURE__ */ jsx8(DispatchSymbols.Provider, { value: dispatch, children }) });
};
...
var Types = ({ initial, dispatch, children }) => {
  return /* @__PURE__ */ jsx9(Context3.Provider, { value: initial, children: /* @__PURE__ */ jsx9(DispatchTypes.Provider, { value: dispatch, children }) });
};
...
function useSymbolsRender(currentProps, props, key) {
  ...
  useEffect10(() => dispatch({ [key]: reset }), [props]);
}
...
var KeyNameComp = (props) => {
  ...
  return /* @__PURE__ */ jsx10(Elm, { ...reset, children });
};
KeyNameComp.displayName = "JVR.KeyNameComp";

// src/external/react-json-view/store.tsx
import { createContext as createContext8, useContext as useContext8, useEffect as useEffect11, useReducer as useReducer7 } from "react";
...
var Expands = ({ initial, dispatch, children }) => {
  return /* @__PURE__ */ jsx11(Context4.Provider, { value: initial, children: /* @__PURE__ */ jsx11(DispatchExpands.Provider, { value: dispatch, children }) });
};
...
var ShowTools = ({ initial, dispatch, children }) => {
  return /* @__PURE__ */ jsx12(Context5.Provider, { value: initial, children: /* @__PURE__ */ jsx12(DispatchShowTools.Provider, { value: dispatch, children }) });
};
...
var Provider = ({
  ...
  useEffect11(() => dispatch({ ...init }), [init]);
  return /* @__PURE__ */ jsx13(Context6.Provider, { value: state, children: /* @__PURE__ */ jsx13(DispatchContext.Provider, { value: dispatch, children: /* @__PURE__ */ jsx13(ShowTools, { initial: showTools, dispatch: showToolsDispatch, children: /* @__PURE__ */ jsx13(Expands, { initial: expands, dispatch: expandsDispatch, children: /* @__PURE__ */ jsx13(Types, { initial: { ...types, ...initialTypes }, dispatch: typesDispatch, children: /* @__PURE__ */ jsx13(Symbols, { initial: symbols, dispatch: symbolsDispatch, children: /* @__PURE__ */ jsx13(Section, { initial: section, dispatch: sectionDispatch, children }) }) }) }) }) }) });
};
...
import { useEffect as useEffect12, useMemo as useMemo2, useRef as useRef4 } from "react";
...
var KeyValues = (props) => {
  ...
  return /* @__PURE__ */ jsx18("div", { className: "w-rjv-wrap", style, children: entries.map(([key, val], idx) => {
    return /* @__PURE__ */ jsx18(KeyValuesItem, { parentValue: value, keyName: key, value: val, level }, idx);
  }) });
};
...
var KayName = (props) => {
  ...
  return /* @__PURE__ */ jsxs4(Fragment3, { children: [
    /* @__PURE__ */ jsxs4("span", { ref: highlightContainer, children: [
      /* @__PURE__ */ jsx18(Quote, { isNumber, "data-placement": "left" }),
      /* @__PURE__ */ jsx18(KeyNameComp, { keyName, value, children: keyName }),
      /* @__PURE__ */ jsx18(Quote, { isNumber, "data-placement": "right" })
    ] }),
    /* @__PURE__ */ jsx18(Colon, {})
  ] });
};
...
var KeyValuesItem = (props) => {
  ...
  if (isNested) {
    ...
    return /* @__PURE__ */ jsx18(Container, { keyName, value: myValue, parentValue, initialValue: value, level: level + 1 });
  }
  const reset = {
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "w-rjv-line", ...reset, children: [
    /* @__PURE__ */ jsx18(KayName, { keyName, value }),
    /* @__PURE__ */ jsx18(Value, { keyName, value, expandKey: subkeyid })
  ] });
};
...
var NestedClose = (props) => {
  ...
  return /* @__PURE__ */ jsx19("div", { style, children: /* @__PURE__ */ jsx19(BracketsClose, { isBrackets: isArray || isMySet, isVisiable: true }) });
};
  ...
  return /* @__PURE__ */ jsxs9(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs9("div", { className: "absolute left-full top-1/2 -translate-y-1/2 ml-2 opacity-0 group-hover:opacity-100 transition-opacity bg-gray-900 px-2 py-1 rounded text-sm whitespace-nowrap pointer-events-none z-10", children: [
          request.method,
          " ",
          request.url,
          /* @__PURE__ */ jsx28("br", {}),
  ...
  return /* @__PURE__ */ jsxs15(
    "li",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs15("h2", { className: "text-md -mt-3 mb-1  flex items-center justify-between gap-2 font-semibold text-white", children: [
          route.pathname,
  ...
  return /* @__PURE__ */ jsxs16(Fragment4, { children: [
    ...
    /* @__PURE__ */ jsx35("div", { className: "relative flex h-full flex-col p-6 px-2 pl-4 lg:px-6", children: /* @__PURE__ */ jsx35(
      "ol",
      {
        ...
        children: routes.map((route, i) => /* @__PURE__ */ jsx35(RouteSegmentInfo, { route, i }, route.id))
      }
    ) })
  ] });
};
...
import { useEffect as useEffect19, useState as useState10 } from "react";
...
var AccordionItem = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx36(AccordionPrimitive.Item, { ref, className: cn("border-b border-b-gray-500", className), ...props }));
AccordionItem.displayName = "AccordionItem";
var AccordionTrigger = React.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx36(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs17(
...
var AccordionContent = React.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx36(
...
var RouteInfo = ({ route: routeToUse, className, openNewRoute, onClose }) => {
  ...
  return /* @__PURE__ */ jsxs21("div", { className: clsx9(className, "relative"), children: [
    isTreeView && /* @__PURE__ */ jsxs21(Fragment5, { children: [
      ...
      /* @__PURE__ */ jsx40("h1", { className: "text-xl text-white font-semibold", children: routeToUse.url }),
      ...
      /* @__PURE__ */ jsxs21("h3", { children: [
        ...
        /* @__PURE__ */ jsxs21("span", { className: "text-white", children: [
          " ",
          path
        ] })
      ] }),
      /* @__PURE__ */ jsxs21("h3", { children: [
        ...
        " ",
        /* @__PURE__ */ jsx40("span", { className: "text-white", children: pathToOpen })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxs21("div", { className: "mb-4 mt-4 flex flex-col gap-2", children: [
      ...
      /* @__PURE__ */ jsxs21("div", { className: "flex flex-wrap gap-2", children: [
        /* @__PURE__ */ jsx40(Tag, { className: "h-max", color: route.hasLoader ? "GREEN" : "RED", children: "Loader" }),
        /* @__PURE__ */ jsx40(Tag, { className: "h-max", color: route.hasClientLoader ? "GREEN" : "RED", children: "Client Loader" }),
        /* @__PURE__ */ jsx40(Tag, { className: "h-max", color: route.hasClientAction ? "GREEN" : "RED", children: "Client Action" }),
      ...
      hasErrorBoundary ? /* @__PURE__ */ jsx40("div", { className: "mr-2", children: hasParentErrorBoundary ? `Covered by parent ErrorBoundary located in: ${errorBoundaryId}` : "" }) : null
    ] }),
    hasWildcard && /* @__PURE__ */ jsxs21(Fragment5, { children: [
      /* @__PURE__ */ jsx40("p", { className: "mb-2 text-gray-500", children: "Wildcard parameters:" }),
      /* @__PURE__ */ jsx40("div", { className: clsx9("mb-4 grid w-full grid-cols-2 gap-2", isTreeView && "grid-cols-1"), children: routeToUse.url.split("/").filter((p) => p.startsWith(":")).map((param) => /* @__PURE__ */ jsxs21("div", { className: "flex w-full gap-2", children: [
...
var RoutesTab = () => {
  ...
  const [treeRoutes, setTreeRoutes] = useState10(createRouteTree(window.__reactRouterManifest?.routes));
  const isTreeView = routeViewMode === "tree";
  ...
  useEffect19(function fetchAllRoutesOnMount() {
      ...
      /* @__PURE__ */ jsx43(
        Tree,
        {
          ...
          pathClassFunc: (link) => (
            ...
            activeRoutes.includes(link.target.data.attributes.id) ? "stroke-yellow-500" : (
              // biome-ignore lint/suspicious/noExplicitAny: need to suppress it as it's always defined
              window.__reactRouterManifest?.routes?.[link.target.data.attributes.id] ? "stroke-gray-400" : "stroke-gray-400/20"
            )
          ),
        ...
        return /* @__PURE__ */ jsxs24(AccordionItem, { value: route.id, children: [
          /* @__PURE__ */ jsx43(AccordionTrigger, { children: /* @__PURE__ */ jsxs24("div", { className: "justify-center flex-wrap text-white flex px-3 lg:px-0 flex-col lg:flex-row w-full items-start lg:items-center gap-1 ", children: [
            ...
            /* @__PURE__ */ jsxs24("div", { className: "lg:ml-auto flex-wrap flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs24("span", { className: " text-left textsm text-gray-500", children: [
                'Url: "',
                pathToOpen,
                '"'
              ] }),
...
var useTabs = (pluginsArray) => {
  ...
  const allTabs = useMemo4(() => [...tabs, ...plugins ? plugins : []], [plugins]);
  const { Component, hideTimeline } = useMemo4(() => {
...
var ContentPanel = ({ plugins }) => {
  ...
  return /* @__PURE__ */ jsxs27("div", { className: "flex h-full w-full overflow-y-hidden", children: [
    ...
    !hideTimeline && /* @__PURE__ */ jsxs27(Fragment6, { children: [
      ...
      /* @__PURE__ */ jsx48("div", { className: clsx14("z-10 hidden lg:block h-full w-1/3 p-2 overflow-y-auto"), children: /* @__PURE__ */ jsx48(TimelineTab, {}) })
    ] })
  ] });
};
  ...
  return /* @__PURE__ */ jsxs28(
    "div",
    {
      ...
      className: clsx15(
        ...
        !isEmbedded ? `fixed left-0 ${panelLocation === "bottom" ? "bottom-0" : "top-0 border-b-2 border-main"}` : "!w-full !h-full !flex-row",
        className
      ),
      children: [
        panelLocation === "bottom" && !isEmbedded && /* @__PURE__ */ jsx49(
          "div",
          {
...
var Embedded = ({ plugins: pluginArray, mainPanelClassName, className }) => {
  ...
  return /* @__PURE__ */ jsx51(
    "div",
    {
      ...
      className: clsx17("react-router-dev-tools react-router-dev-tools-reset h-full flex-row w-full", className),
      children: /* @__PURE__ */ jsxs30(MainPanel, { className: mainPanelClassName, isEmbedded: true, isOpen: true, children: [
...
var useCheckIfStillDetached = () => {
  ...
  const checkDetachment = useCallback6(
    // biome-ignore lint/suspicious/noExplicitAny: we don't care about the event type
    (e) => {
...
function removeStyleAndDataAttributes(inputString) {
  ...
  resultString = resultString.replaceAll(styleRegex, (_match, styleValue) => {
