    ...
    isTreeView ? /* @__PURE__ */ jsxs24("div", { className: "flex h-full w-full", children: [
      /* @__PURE__ */ jsx43(
        Tree,
        {
          ...
          pathClassFunc: (link) => activeRoutes.includes(link.target.data.attributes.id) ? "stroke-yellow-500" : window.__reactRouterManifest?.routes?.[link.target.data.attributes.id] ? "stroke-gray-400" : "stroke-gray-400/20",
...
import { useCallback as useCallback5, useEffect as useEffect21, useState as useState12 } from "react";
var useResize = () => {
  const { setSettings, settings } = useSettingsContext();
...
import { useEffect as useEffect27, useState as useState18 } from "react";
...
import { useCallback as useCallback6, useContext as useContext9, useEffect as useEffect24, useState as useState15 } from "react";
