import { insert_nonce_217a, get_work_par_217a, elementary_iteration_217a, } from "./rs-keypears_pow5-inline-base64/keypears_pow5.js";
...
export function elementaryIteration(header) {
    return FixedBuf.fromBuf(32, WebBuf.fromUint8Array(elementary_iteration_217a(header.buf)));
}
