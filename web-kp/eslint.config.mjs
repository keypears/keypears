...
export default [
  // Configuration for app files (React Router/TypeScript)
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        Response: "readonly",
        React: "readonly",
        // Node globals (for server-side rendering)
        process: "readonly",
        Buffer: "readonly",
        __dirname: "readonly",
        __filename: "readonly",
  ...
  // Configuration for server.ts and build scripts
  {
    files: ["server.ts", "build-*.ts", "*.config.{ts,js,mjs}"],
    languageOptions: {
      parser: typescriptParser,
      parserOptions: {
        ecmaVersion: 2022,
